...
<head>
    ...
    <style>
        ...
        .value { font-size: 18px; color: #222; }
        ...
        .actions { margin-top: 40px; display: flex; gap: 10px; }
...
<body>
    <div class="container">
        ...
        <div class="actions">
            <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-edit">Edit This Category</a>
